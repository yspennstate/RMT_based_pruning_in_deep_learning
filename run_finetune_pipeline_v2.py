...
OUT_DIR = Path("/workspace/finetune_results_v2")
...
CYCLES = [
    # cycle 0 placeholder: s=0.40 checkpoint copied from v1 cycle 07; 0 epochs -> resume logic skips
    (0.40,  0, 0.0,    "loaded_from_v1_cycle_07",                            False),
    (0.45,  4, 2.5e-5, "splus_budget_b1.25_sd0.70_p1.0",                     False),
    (0.50,  5, 2.2e-5, "splus_budget_b1.25_sd0.70_p1.0",                     False),
    (0.55,  6, 2.0e-5, "splus_budget_b1.25_sd0.70_p1.0",                     False),
    (0.60,  8, 1.8e-5, "splus_budget_b1.50_sd0.85_p1.0_ba1.00_bm2.00",       False),
    (0.65, 10, 1.6e-5, "splus_budget_b1.50_sd0.85_p1.0_ba1.00_bm2.00",       False),
    (0.70, 12, 1.4e-5, "splus_budget_b1.50_sd0.85_p1.0_ba1.00_bm2.00",       False),
]
