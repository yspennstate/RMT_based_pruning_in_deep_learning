...
MaskLLM-4V \cite{fang2024maskllm} & ViT-B/16 & \(2{:}4\) learned mask & \(\mathbf{79.46}\) & $\mathbf{+0.31}$ & 20 mask ep. & weights frozen; no ViT endpoint speedup reported \\
...
Pool--Yu perm. \cite{pool2021channel} & ResNet-50 & \(2{:}4{+}\)perm & \(\mathbf{76.29}\) & $\mathbf{+0.13}$ & 90 FT & no runtime overhead; V100 search time \(02{:}13\) = \(0.10\%\) of train+FT \\
