...
MaskLLM (vision/4V) \cite{fang2024maskllm} & ViT-B/16 & \(2{:}4\) learned mask & 79.46 & \(+0.31\) & 20 mask ep. & Learned-mask ViT \(2{:}4\) context (MaskLLM vision/4V setting); weights frozen, no ViT endpoint speed reported. \\
...
Pool--Yu perm. \cite{pool2021channel} & ResNet-50 & \(2{:}4\)+perm & 76.29 & \(+0.13\) & repeated train/FT & Closest channel-permutation semi-structured ResNet context (no inference-time overhead). \\
